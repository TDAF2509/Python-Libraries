...
time.sleep(1)
def security():
    secure= (['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'])
    number = (-1000,0)
    number1= (3,1000)
    choice= input("1)START THE GAME\n2)QUIT\n")
    while choice in secure or choice in number or choice in number1:
...
def security2():
    secure2= (['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'])
    number2 = (-1000,0)
    number3= (3,1000)
    icon= input("SELECT 1 FOR X\nSELECT 2 FOR O\n")
    while icon in secure2 or icon in number2 or icon in number3:
        print ("THE VALUE YOU ENTERED IS INVALID\n")
        (security2())
    else:
        if icon =='1':
...
def game():
    ...
    def x_place():
        ...
        secure3=(['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','x','y','z'])
        if i==0:
            enteredalready=[]
        x= int(input("PLEASE ENTER A SPACE FOR X "))
        while x in secure or x<1 or x>9 :
